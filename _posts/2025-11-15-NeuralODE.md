...
$$
\int_0^T \nabla_{\vecz}​\cdot \vecv_{\vecphi}​(\vecz(t),t)dt \approx \sum_{i=0}^{N−1} ​w_i \nabla​_{\vecz} \cdot​ \vecv_{\vecphi}​(\vecz(t_i​),t_i​)=\sum_{i=0}^{N−1} ​w_i \left.\text{Tr}\Big(\frac{\partial \vecv_{\vecphi}(\vecz(t), t)}{\partial \vecz}\Big) \right|_{t=t_i} \approx \left. \veceps^T \Big(\frac{\partial \vecv_{\vecphi}}{\partial \vecz} \Big) \right|_{z(t_i),t_i} \veceps,
$$
