...
We will use authors quote to state why this is called planar flow:

> modifies the initial density q0 by applying a series of contractions and
> expansions in the direction perpendicular to the hyperplane
> $\vecx^T \vecz + b = 0$, hence we refer to these maps as planar flows.

<p style="margin-left: 2em; text-indent: -1em; font-style: italic;">
“Reinforcement learning can be viewed as the formalization of trial-and-error learning.”  
— Sutton & Barto (2018)
</p>
