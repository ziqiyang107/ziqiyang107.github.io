...
$$
\vecx_{t-1}= \frac{1}{\sqrt{\alpha_t}}\Big(\vecx_t - \frac{1-\alpha_t}{\sqrt{1-\bar{\alpha}_t}}\veceps_{\theta}(\vecx_t, t) \Big) + \sigma_t \vecz
$$

where $\vecz \sim \mathcal{N}(\veczero, \vecI)$, and $\vecx_0$ is our generated sample
