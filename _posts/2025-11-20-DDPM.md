...
This equation is almost the equatinon(5) in {% include cite.html key="ho2020denoising"%}, but doesn't include the expectation over $\vecx_0$ and sign is reversed. We use the same definition as in the DDPM paper
...
\textcolor{red}{Derive equation(6)(7) in }{% include cite.html key="ho2020denoising"%}:
