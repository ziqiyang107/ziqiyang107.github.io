...
And
> ...expressiveness of the reverse process is ensured in part by the choice of Gaussian conditionals in $$p_{\theta}(x_{t−1}|x_t)$$, because both processes have the same functional form when βt are small...
