...
$$
\begin{align*}
\vecmu_{\theta}(\vecx_t, t) =& \frac{\sqrt{\bar{\alpha}_{t-1}}\beta_t}{1-\bar{\alpha}_t}\vecx_{\theta}(\vecx_t, t) + \frac{\sqrt{\alpha_t}(1-\bar{\alpha}_{t-1})}{1-\bar{\alpha}_t}\vecx_t  \label{Eq: Eq:mu_theta form x}  \\
